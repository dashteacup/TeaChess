...
public class PawnTest {
    ...
    /**
     * Walk a white Pawn around the board, confirming that valid moves/captures
     * execute properly, and invalid ones fail.
     */
    @Test
    public void walkWhitePawn()
    {
        ...
        // capture up-right
        assertTrue(walker.capture(e, 5));
        // bad, can't move 2 past start
        assertFalse(walker.move(e, 7));
        // up 1
        assertTrue(walker.move(e, 6));
        // capture up-left
        assertTrue(walker.capture(d, 7));
        // bad can't capture up
        assertFalse(walker.capture(d, 8));
        // up 1
        assertTrue(walker.move(d, 8));
        // bad, can't go off board
        assertFalse(walker.move(d, 9));
    }

    /**
     * Walk a black Pawn around the board, confirming that valid moves/captures
     * execute properly, and invalid ones fail.
     */
    @Test
    public void walkBlackPawn()
    {
        ...
        assertFalse(walker.move(g, 4));
        // capture down-left
        assertTrue(walker.capture(f, 5));
        // capture down-left
        assertTrue(walker.capture(e, 4));
        // capture down-left
        assertTrue(walker.capture(d, 3));
        // down 1
        assertTrue(walker.move(d, 2));
        // capture down-right
        assertTrue(walker.capture(e, 1));
    }
}
